...
while running:
    ...
    if level == 3:
        ...
        screen.blit(text1, (80, 700))
        screen.blit(text2, (80, 720))
        screen.blit(text3, (148, 755))
        screen.blit(text4, (548, 755))
        n += 1
    if level == 4:
        pygame.draw.rect(screen, (0, 0, 0), ((0, 700), (800, 100)))
        pygame.draw.rect(screen, (255, 255, 127), ((100, 750), (200, 40)))
